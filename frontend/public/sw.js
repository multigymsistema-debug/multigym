...
const shell=[root.href,new URL('manifest.json',root).href,new URL('logo-symbol.png',root).href,new URL('logo-full.png',root).href,new URL('icon-192.png',root).href,new URL('icon-512.png',root).href];
