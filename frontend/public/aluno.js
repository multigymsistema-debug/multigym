...
const visual = (kind='') => `<div class="movement-visual"><div class="movement-step"><span>1</span><b>Posição inicial</b><svg viewBox="0 0 180 110" role="img" aria-label="Posição inicial do exercício"><circle cx="42" cy="28" r="10"/><path d="M42 40 L42 72 M42 48 L25 60 M42 48 L64 59 M42 72 L27 96 M42 72 L61 96"/><path d="M18 100 H72"/></svg></div><div class="movement-arrow">→</div><div class="movement-step active"><span>2</span><b>Movimento controlado</b><svg viewBox="0 0 180 110" role="img" aria-label="Movimento do exercício"><circle cx="42" cy="28" r="10"/><path d="M42 40 L42 72 M42 48 L22 45 M42 48 L67 34 M42 72 L27 96 M42 72 L61 96"/><path d="M15 100 H73"/><path class="motion-line" d="M82 35 Q125 8 155 38 M145 28 l12 10 -14 6"/></svg></div></div><small class="visual-caption">Faça a ida e a volta sem impulso</small>`;
